...
ggplot(vac_subset, mapping = aes(x = total_vaccinations, y = people_fully_vaccinated)) +
    ...
    geom_line(aes(color = country), linetype = "dashed") +
    geom_abline() +
    coord_fixed()
```
...
```{r ex1-q1, echo=FALSE}
question("After many total vaccinations were the first German citizens fully vaccinated?",
  answer("500,000"),
  answer("5,000,000"),
...
```{r ex1-q2, echo=FALSE}
question("What can we learn something about the vaccination strategies of different countries from their respective curves?",
  answer("Israel is completing vaccinations at a higher rate than Germany", correct = TRUE),
  answer("Germany is completing vaccinations at a higher rate than Israel"),
  answer("New vaccinations in Denmark are more often used to complete a vaccination than in France", correct = TRUE)
)
```
